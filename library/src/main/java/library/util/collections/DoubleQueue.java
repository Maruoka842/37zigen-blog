...
public class DoubleQueue {
	private DoubleDeque d = new DoubleDeque();
	 ...
	 * 計算量: O(N) (N = size())
	 */
	public DoubleQueue copy() {
		DoubleQueue ret = new DoubleQueue();
		ret.d = d.copy();
		return ret;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DoubleQueue)) return false;
		DoubleQueue other = (DoubleQueue) obj;
